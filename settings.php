...
<table>
<tr>
  <td>Home Title Text:</td>
  <td><input type="text" name="home_title_text" class="ss_text" value="<?php echo stripslashes(stripslashes(get_option($shortname.'_home_title_text',''))); ?>" /></td>
</tr>
<tr>
